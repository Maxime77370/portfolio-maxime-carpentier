...
export default function AnimatedBackground({ fromColor = "rgba(0, 0, 0, 1)", toColor = "rgba(0, 0, 0, 1)", ballColor = "rgba(255, 255, 255, 1)" }: AnimatedBackgroundProps) {
    type BallAnimation = {
        id: number;
        size: number;
        top: string;
    ...
    const [ballAnimations, setBallAnimations] = useState<BallAnimation[] | null>(null);
