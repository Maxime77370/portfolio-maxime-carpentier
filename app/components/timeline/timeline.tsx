...
export default function ProjectTimeline() {
  ...
  const allTimelineData = Object.values(dictionary).sort(
    (a: DictionaryItem, b: DictionaryItem) => (a.date > b.date ? 1 : -1)
  );
  ...
  return (
    <>
      ...
      >
        {/* Ligne verticale */}
        <div className="border-l-2 border-gray-300 absolute left-1/2 top-0 bottom-0 -translate-x-1/2 pointer-events-none" />
